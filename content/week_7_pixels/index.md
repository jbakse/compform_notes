...
10. Change the image resolution to `50x50`, adjust scatter to fill.
11. Instead of drawing single pixels, draw little `+` marks at random locations.
12. Make each `+` a random color.
...
3. Feed the program you made above a grayscale or color image (under 200x200). You'll have to do this in your own editor, you'll need a local server.
...
7. Feed the program you made above a grayscale or color image (under 200x200).

## Modify Example 3
8. Invert the drawing, so that circles appear where the input pixels are black.
9. Feed the program you made above a grayscale or color image (under 200x200).
